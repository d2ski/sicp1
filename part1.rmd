...
The variance of the sample distribution is `r vardistr`. The theoretical variance
is `r varteor`, which is calculated as varicance of exponential distribution divided by n.  
...
The theoretical mean (1/lambda) is `mteor` = `r mteor`.  